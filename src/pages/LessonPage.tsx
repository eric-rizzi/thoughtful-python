...
const LessonPage: React.FC = () => {
  ...
  const renderSection = (section: LessonSection) => {
    switch (section.kind) {
      ...
      case "Prediction":
        return (
          <PredictionSection
            key={section.id}
            lessonId={lessonId!}
            section={section as PredictionSectionData}
          />
        );
      case "MultipleChoice":
        return (
          <MultipleChoiceSection
            key={section.id}
            lessonId={lessonId!}
            section={section as MultipleChoiceSectionData}
          />
        );
      case "MultiSelection":
        return (
      ...
      case "Reflection":
        return (
          <ReflectionSection
            key={section.id}
            lessonId={lessonId!}
            section={section as ReflectionSectionData}
          />
        );
      case "Coverage":
        return (
      ...
      default:
        console.warn(
          `Unknown section kind encountered: ${section.kind} for section ID: ${section.id}`
        );
        return (
