...
const HomePage: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    if (error) {
      return <div className={styles.error}>Error loading learning paths: {error}</div>;
    }

    if (units.length === 0) {
      return <div className={styles.loading}><p>No learning paths available yet. Check back soon!</p></div>;
    }
            ...
            <div className={styles.unitCard}>
              ...
              <div className={styles.unitContent}>
                ...
                <div className={styles.unitDetails}>
                    <div className={styles.unitLessons}>{unit.lessons.length} lessons</div>
  ...
  return (
    <div>
      <section className={styles.welcome}>
        ...
        <p>Learn Python programming directly in your browser - no installation required!</p>
      </section>
